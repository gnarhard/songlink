...
class SongLinkService
{
     ...
     */
    public function storeSongLinks(string $spotifyUrl, string $title, string $slug, bool $isSingle = true, ?string $album_artwork_path = null, ?string $youtube_video_id = null): ?SongLink
    {
